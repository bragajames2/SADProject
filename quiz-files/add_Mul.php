...
?>
            ...
            <button type="submit" id="addquestion" class="btn btn-info btn-large" value="submit" name="addquestion">+ Add Question</button>
			<button type="submit" id="home" class="btn btn-warning btn-large" value="submit" name="home">HOME</button>
			<button type="submit" id="previewquiz" class="btn btn-success btn-large" value="submit" name="previewquiz">PREVIEW QUIZ</button>
			
			<script>

							$('#addquestion').click(function(){
								var form = document.getElementById("quiz")
								form.action = "add_Mul_exec.php";
								form.submit();
								});
