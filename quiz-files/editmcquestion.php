                                   ...
                                   <form name="editmcqestion" data-parsley-validate class="form-horizontal form-label-left" action="editmcquestion_exec.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1 col-sm-1 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-1 col-xs-1" name="questionid" placeholder="<?php $sql2 = "SELECT * FROM quizdb.$qName where questionid = '$_GET[questionid]' ";
$records2=mysqli_query($conn5,$sql2) or die(mysqli_error());
$row2 = mysqli_fetch_assoc($records2);
...
echo $row2['question'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="A" value="<?php $sql2 = "SELECT * FROM quizdb.$qName where questionid = '$_GET[questionid]' ";
$records2=mysqli_query($conn5,$sql2) or die(mysqli_error());
$row2 = mysqli_fetch_assoc($records2);
echo $row2['A'];?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="B" value="<?php $sql2 = "SELECT * FROM quizdb.$qName where questionid = '$_GET[questionid]' ";
$records2=mysqli_query($conn5,$sql2) or die(mysqli_error());
$row2 = mysqli_fetch_assoc($records2);
echo $row2['B'];?>">
                                            </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="C" value="<?php $sql2 = "SELECT * FROM quizdb.$qName where questionid = '$_GET[questionid]' ";
$records2=mysqli_query($conn5,$sql2) or die(mysqli_error());
$row2 = mysqli_fetch_assoc($records2);
echo $row2['C'];?>">
                                            </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="D" value="<?php $sql2 = "SELECT * FROM quizdb.$qName where questionid = '$_GET[questionid]' ";
$records2=mysqli_query($conn5,$sql2) or die(mysqli_error());
$row2 = mysqli_fetch_assoc($records2);
 echo $row2['D'];?> ">
                                            </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-1 col-sm-1 col-xs-12">
												...
												<input class="form-control col-md-1 col-xs-1" name="answer" value="<?php$sql2 = "SELECT * FROM quizdb.$qName where questionid = '$_GET[questionid]' ";
$records2=mysqli_query($conn5,$sql2) or die(mysqli_error());
$row2 = mysqli_fetch_assoc($records2);
echo  $row2['answer'];?>">
