                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                   ...
                                   <form name="addmcquestion.php" data-parsley-validate class="form-horizontal form-label-left" action="addmcquestion_exec.php" method="post">
										...
										<label class="control-label col-md-6 col-sm-6 col-xs-12">Enter the choices on the space provided</label><br><br>
                                        <div class="form-group">
                                            <label class="control-label col-md-2 col-sm-1 col-xs-12">A. <span class="required">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="A" >
                                            </div>
											</div>
                                        <div class="form-group">
                                            <label class="control-label col-md-2 col-sm-1 col-xs-12">B. <span class="required">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="B" >
                                            </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="C" >
                                            </div>
											</div>
										<div class="form-group">
                                            <label class="control-label col-md-2 col-sm-1 col-xs-12">D. <span class="required">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" name="D" >
                                            </div>
											 </div>
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												...
												<select class="btn btn-default dropdown-toggle" name="answer">
