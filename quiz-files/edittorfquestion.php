...
echo $row2['question'];  ?>">
										...
										<input type="hidden"  class="form-control col-md-7 col-xs-12" name="A" value="True">
										<input type="hidden"  class="form-control col-md-7 col-xs-12" name="B" value="False">
                                       
										<div class="form-group">
                                            <label class="control-label col-md-2 col-sm-1 col-xs-12">Correct Answer <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                
												<select class="btn btn-default dropdown-toggle" name="answer" value="">
