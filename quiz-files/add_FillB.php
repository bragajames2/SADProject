...
?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="question" name="question" placeholder="Enter your question here. Use ___ to indicate blank">
            </div>
            <div class="form-group">
            ...
            <button type="submit" id="addquestion" class="btn btn-info btn-large" value="submit" name="submit">+ Add Question</button>

      
            <button type="submit" id="home" class="btn btn-warning btn-large" value="submit" name="submit">HOME</button>
      
            <button type="submit" id="previewquiz" class="btn btn-success btn-large" value="submit" name="submit">PREVIEW QUIZ</button>
     	
			<script>

							$('#addquestion').click(function(){
								var form = document.getElementById("quiz")
								form.action = "add_FillB_exec.php";
								form.submit();
								});
